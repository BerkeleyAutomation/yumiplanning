...
if __name__=="__main__":
    ...
    # lpath, rpath = yk.compute_cartesian_path(l_start=YuMiKinematics.L_NICE_POSE,
    #     l_goal=L_TWIST_POSE,l_qinit=YuMiKinematics.L_NICE_STATE,
    #     r_start=YuMiKinematics.R_NICE_POSE,r_goal=R_TWIST_POSE,r_qinit=YuMiKinematics.R_NICE_STATE)
    lpts=[YuMiKinematics.L_NICE_POSE,L_TWIST_POSE,L_OUT_POSE,YuMiKinematics.L_NICE_POSE]
    rpts=[YuMiKinematics.R_NICE_POSE,R_TWIST_POSE,R_OUT_POSE,YuMiKinematics.R_NICE_POSE]
    lpath,rpath=yk.interpolate_cartesian_waypoints(lpts,rpts,YuMiKinematics.L_NICE_STATE,
                   YuMiKinematics.R_NICE_STATE)
    print("l_waypoints=[")
    for q in lpath:
